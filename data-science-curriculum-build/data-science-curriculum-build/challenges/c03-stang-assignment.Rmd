...
Notes from wiki for what are the relationships between Elasticity and Poisson ratio
- A stiffer material will have a higher Elasticity modulus
- Poisson ratio is a measure of the expansion or contraction of a material in direction perpendicular to where the load is being applied.
- Most materials have a poisson ratio between 0 and 0.5
...
- Is there "one true value" for the material properties of Aluminum?
  - No, there is not one true value, as for the same thickness, the elasticity and poisson ratio have different values.
- How many aluminum alloys are in this dataset? How do you know?
  - There is one aluminum alloy in the dataset: "al_24st." Since there is only one I didn't include it in my initial EDA
- What angles were tested?
  - 0, 45, 90
- What thicknesses were tested?
  - 0.022, 0,032, 0.064, 0.081
  
- What is the relationship between Elasticity and Poisson Ratio, and how does applying force at different angles of rolling change that relationship?
...
- From the graph we can assume that elasticity and poisson ratio have a positive correlation.
- An angle of 90 degrees has a much more shallow increase in the poisson ratio as the elasticity goes up
- There doesn't seem to be a linear relationship between the rolling angle and the poisson ratio, as an angle of 45 has a higher poisson ratio than 0 or 90, the two ends of the data.
...
- Does this graph support or contradict the claim above?
  - This graph would contradict the claim that elasticity is an intensive material property as elasticity seems to be dependent on how thick a material is.
- Is this evidence *conclusive* one way or another?
  - This graph by itself is not conclusive, as there are other variables unaccounted for that elasticity could be dependent on that is being disguised as thickness in this graph. But my previous visualization showed that elasticity was not in fact dependent on the angle of the roll which was the only other variable that wasn't held constant when collecting this data. Therefore, based on the two graphs created, this evidence is conclusive.
