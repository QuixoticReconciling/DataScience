...
## Your code here!
ggplot(data = diamonds, mapping = aes(y = price, x = carat), ylab="price", xlab="carat", main="Price vs. Carat") +
  geom_point (col = "blue") +
...
- Price increases as the carats increase
- Price seems to steadily increase between .75-2. both above and below
  those carat values price increase is more shallow
...
- Additional observation is that the more carats a diamond has, the
