...
**Observations**:
- We don't see the real highway values, but we see the sum at each city value when we used stack.
- Dodge gives us a much better representation.
...
**Observations**:
- The addition of colors doesn't give us any additional information. but based on this data we would assume that there are far more SUVs than any other car type
...
**Observations**:
- This graph shows us what kind of drive car types use. Most cars drive with the forward wheels rather than the back wheels which is an observation I had not realized.
...
- What was the difference between `v1` and `v2`?
    - v2 used the third axes effectively. The third axes added information to the data we were getting where as v1 merely color coded the data that was already there.
...
**Observations**
- Most car brands have a specialty where they produce one class of car more than any other.
- There are more manufacturers that specialize in suvs than any other class.
There are a few "all-rounders" like toyota, volkswagen, subaru, and chevrolet that make several different kinds of cars.
