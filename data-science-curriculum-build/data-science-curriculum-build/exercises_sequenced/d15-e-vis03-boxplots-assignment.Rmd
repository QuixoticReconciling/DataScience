...
- Which plot is more effective for answering the previous question?
  - The boxplot display is much better to help visualize that
...
- The median price tends to increase, most drastically from 0 to 2, but after that the rate of increase slows by a lot
- The carat values with the biggest price range are from 3-3.5.
