...
- cov_depth, there isn't much variation compared to its scale
- cov_diff is large, this is because the difference between depth and depth_computed is so small which causes the covariance to be super big.
...
**Observations**:
- Ideal diamonds don't have the highest price!
