...
- Is the bolded response **active** or **passive**? Why?
    - It is active, as the presenter is actively engaging with what the colleague said.
- Is the bolded response **constructive** or **destructive**? Why?
    - It is constructive, as it builds off of what the colleague said and says exactly what could be better.
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
    - It makes me feel like the question is much more excepted as compared to the statement previously.
...
- Is the bolded response **active** or **passive**? Why?
    - It's active, because the presenter engages in what the colleague says
- Is the bolded response **constructive** or **destructive**? Why?
    - It's destructive as the presenter conveys a negative response
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
...
- Is the bolded response **active** or **passive**? Why?
    - It is very passive, as the response is only loosely related to the topic at hand
- Is the bolded response **constructive** or **destructive**? Why?
    - This depends a lot on the tone this question was asked in, but I would consider it to be constructive, as the colleague seems genuinely curious.
